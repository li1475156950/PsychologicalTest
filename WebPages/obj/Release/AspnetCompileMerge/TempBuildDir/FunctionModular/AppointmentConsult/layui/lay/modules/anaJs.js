...
layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    u.prototype.config = function (i) {
        ...
        if (layui.each(Array(5), function (i) {
            ...
            isgroup: !0,
            voice: "default.mp3"
        }, i), window.JSON && window.JSON.parse) return A(i), this
    }, u.prototype.on = function (i, a) {
    ...
    }, u.prototype.setChatMin = function () {
        return N(), this
        ...
        return K(i), this
    }, u.prototype.notice = function (i) {
        return J(i), this
    }, u.prototype.add = function (i) {
        return M(i), this
    }, u.prototype.setFriendGroup = function (i) {
        return M(i, "setGroup"), this
    }, u.prototype.msgbox = function (i) {
        return V(i), this
    }, u.prototype.addList = function (i) {
        return U(i), this
    }, u.prototype.removeList = function (i) {
        return W(i), this
    }, u.prototype.setFriendStatus = function (i, a) {
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        A = function (i) {
            ...
            return mine = a.mine || {}, local = layui.data("layim")[mine.id] || {}, obj = {
                ...
                j = e.extend(j, s), H(n(y).render(s)), (l.close || i.min) && T(), layui.each(r.ready, function (i, a) {
                    a && a(s)
                })
        ...
        H = function (i) {
            return t.open({
                ...
                success: function (i) {
                    ...
                    }), a.length > 0 && (a.reverse(), n.html(a.join(""))), L(), ti.sign()
                },
                cancel: function (i) {
                    T();
        ...
        z = function (i) {
            ...
            if (a[0]) {
                var s = w.find(".layim-chat-list"),
                    ...
                    u = a.children(".layim-chat-box");
                return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({
                    height: w.height()
                }).show(), u.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), u.append(n(f).render(l)), I(i), E()), q(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || P(), D(i), Q(), C
            }
            l.first = !0;
            var c = C = t.open({
                type: 1,
        ...
        q = function (i, a) {
            ...
            var n = i.index() === -1 ? 0 : i.index(),
                l = ".layim-chat",
                d = w.find(l).eq(n),
                u = w.find(".layui-layer-max").hasClass("layui-layer-maxmin");
            if (a) {
                i.hasClass(o) && q(0 === n ? i.next() : i.prev());
                var c = w.find(l).length;
                return 1 === c ? t.close(C) : (i.remove(), d.remove(), 2 === c && (w.find(".layim-chat-list").hide(), u || w.css("width", "600px"), w.find(".layim-chat-box").css("margin-left", 0)), !1)
            }
        ...
        K = function (i) {
            ...
            if (w) {
                ...
                var r = w.find(".layim-chat").eq(l),
                    u = r.find(".layim-chat-main ul");
                i.system ? l !== -1 && u.append('<li class="layim-chat-system"><span>' + i.content + "</span></li>") : "" !== i.content.replace(/\s/g, "") && u.append(n(h).render(i)), Z()
            }
        },
        ...
        Q = function () {
            ...
            a.focus(), a.off("keydown").on("keydown", function (i) {
                var e = layui.data("layim")[j.mine.id] || {},
                    t = i.keyCode;
                if ("Ctrl+Enter" === e.sendHotKey) { if (CanSend) return void (i.ctrlKey && 13 === t && $()); }
                if (13 === t) {
                    if (CanSend) {
        ...
        ti = {
                ...
                var a = x.find(".layui-layim-search"),
                    ...
                    n = function (i) {
                        ...
                        if ("" === a) ti.tab(0 | ti.tab.index);
                            ...
                            if (n.length > 0)
                                for (var c = 0; c < n.length; c++) o += '<li layim-event="chat" data-type="' + n[c].type + '" data-index="' + n[c].index + '" data-list="' + n[c].list + '"><img src="' + n[c].avatar + '"><span>' + (n[c].username || n[c].groupname || "佚名") + "</span><p>" + (n[c].remark || n[c].sign || "") + "</p></li>";
                ...
                i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), ti.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                    ...
                    success: function (a) {
                        var t = j.base.members || {},
                            ...
                            d = {},
                            u = w.find(".layui-layer-max").hasClass("layui-layer-maxmin"),
                            c = "none" === w.find(".layim-chat-list").css("display");
                        u && s.css({
                            width: e(window).width() - 22 - (c || 200)
            ...
            playAudio: function (i) {
                var a = ti.playAudio.audio,
                    e = a || document.createElement("audio"),
                    n = function () {
                        e.pause(), i.removeAttr("status"), i.find("i").html("&#xe652;")
                    };
                return e.play ? void (i.attr("status") ? n() : (a || (e.src = i.data("src")), e.play(), i.attr("status", "pause"), ti.playAudio.audio = e, i.find("i").html("&#xe651;"), e.onended = function () {
                    n()
                }, e.onerror = function () {
                    t.msg("播放音频源异常")
                })) : t.msg("您的浏览器不支持audio")
    ...
    i("layim", new u)
}).addcss("modules/layim/layim.css?v=3.53Pro", "skinlayimcss");