...
function GroupConsultationInfo() {
    ...
    function fnLoadRowControl(param) {
        param.Container.append("<th style='width:200px;word-break: keep-all;text-align:right;font-weight: bold;padding: 5px 5px 5px 0px;font-size:12px;' ><label>" + param.Title + "：" + "<label></th>" +
