...
!function () {
    ...
    AbstractChosen = function () {
        ...
        return AbstractChosen.prototype.set_default_values = function () {
            ...
            this.search_contains = true || !1,//2016-10-25  -----修改 这里是实现下拉列表的 全局模糊匹配 默认是在第一位匹配【this.options.search_contains】  改成true是全局匹配
        ...
        AbstractChosen.prototype.container_width = function (obj) {
            var objwidth = "";
            //if (this.form_field.offsetWidth == 0) {
            objwidth = obj.style.width + "";//.replace("px", "")//.replace("%", "");//---2016-10-25  -----修改此方法  修改了由于嵌套导致宽度为0的bug
            //} else {
            //    objwidth = this.form_field.offsetWidth + "";
            //}
            //alert("obj.style.width:" + obj.style.width);
            //alert("this.form_field.offsetWidth:" + this.form_field.offsetWidth);


            //return null != this.options.width ? this.options.width: "" + objwidth;
            return objwidth;
        ...
        AbstractChosen.default_multiple_text = "选择一些选项",
        AbstractChosen.default_single_text = "选择一个选项",
    ...
    Chosen = function (c) {
        ...
        Chosen.prototype.set_up_html = function () {
            ...
            c = {
                "class": b.join(" "),
                style: "width: " + this.container_width(this.form_field) + ";",
